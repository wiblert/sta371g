...
\\
\noindent {\bf TA:} & Ryan Matthew O'Donnell \\
\noindent {\bf Email:} & \href{mailto:rodonnell@utexas.edu}{\tt rodonnell@utexas.edu}  \\
\noindent {\bf Office Hours:} & TBD \\
\end{tabular}
...
\caltext{1/30/17}{Simple regression}
\caltext{2/6/17}{Multiple regression}
\caltext{2/13/17}{Dummy variables}
\caltext{2/15/17}{Interactions}
\options{2/22/17}{\noclassday}
\caltext{2/22/17}{Midterm 1}

\caltext{2/27/17}{Diagnostics and transformations}
\caltext{3/6/17}{Model selection}
\caltext{3/8/17}{Logistic regression}
\caltext{3/22/17}{Autoregression}
\caltext{3/27/17}{Moving averages and smoothing}
\options{3/29/17}{\noclassday}
\caltext{3/29/17}{Midterm 2}

\caltext{4/3/17}{Decision trees}
\caltext{4/19/17}{Simulation}
